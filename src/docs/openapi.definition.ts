      ...
      schemas: {
        ...
        DemoRequestCreate: {
          ...
          properties: {
            ...
            workEmail: { type: 'string', format: 'email', example: 'jane@example.com' },
            company: { type: 'string', example: 'EventForge Labs' },
            role: { type: 'string', example: 'Head of Operations' },
            teamSize: { type: 'string', example: '11-50' },
            useCase: { type: 'string', example: 'Corporate events' },
            estimatePrice: {
              type: 'number',
              minimum: 0,
              example: 2500,
              description: 'Estimated budget for the event (USD)',
            },
            source: {
              type: 'string',
          ...
          required: ['fullName', 'workEmail', 'company', 'role', 'teamSize', 'useCase', 'estimatePrice'],
        },
      },
    },
    paths: {
